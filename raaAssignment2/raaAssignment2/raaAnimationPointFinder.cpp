...
{
	// You should use a set of finders to find the specific animation point for a particular tile. 
	...
	// this will give you a matix transform for the animation point which you will need to decompose into 
